...
db.by_road_type.find({ county: "강릉시" },{"교차로내.accident_count" : 1, "터널안.accident_count" : 1});
...
db.inventory.insertMany([
  ...
  // 쿼리 예제, 한문장씩 확인해보기. (projection이 생략됨 -> 모든 컬럼 보여줘.)
...
db.inventory.find({$or:[{qty:{$gt:90}},{qty:{$lt:50}}]}); //논리연산자(or)가 조건보다 앞에 있는게 앞선 것들과는 다른점
